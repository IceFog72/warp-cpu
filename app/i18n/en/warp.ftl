...
settings-features-force-software-rendering = Force CPU software rendering
settings-features-force-software-rendering-description = Uses llvmpipe software rendering on Linux to avoid dedicated GPU/VRAM usage. Changing this setting applies after restart.
settings-features-cpu-renderer = Use CPU renderer
settings-features-cpu-renderer-description = Uses Warp's CPU renderer on Linux. Changing this setting applies after restart.
...
toggle-suffix-software-rendering = CPU software rendering
