...
settings-features-force-software-rendering = 强制使用 CPU 软件渲染
settings-features-force-software-rendering-description = 在 Linux 上使用 llvmpipe 软件渲染,避免占用独立 GPU/VRAM。更改此设置后需要重启生效。
settings-features-cpu-renderer = 使用 CPU 渲染器
settings-features-cpu-renderer-description = 在 Linux 上使用 Warp 的 CPU 渲染器。更改此设置后需要重启生效。
...
toggle-suffix-software-rendering = CPU 软件渲染
